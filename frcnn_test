...
config_output_filename = "F:\\strawberry_disease_detection\\keras_frcnn\\config.pickle"
...
img_path = "F:\\strawberry_disease_detection\\keras_frcnn\\test_image"
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    cv2.imwrite('F:\\strawberry_disease_detection\\keras_frcnn\\for_small_disease\\imgs{}.png'.format(idx),img_scaled)
    print(all_dets)
